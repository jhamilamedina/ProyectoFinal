...
datos_empresas = [
    ...
    {'logo': 'static/images/shalom.png', 'nombre': 'Shalom', 'sede_principal': 'Avenida México 1187,Cercado de Lima, Perú', 'descripcion': 'Shalom tiene una amplia red de distribución de puntos de entrega y acopio en los 24 departamentos del Perú', 'sitio_web': 'https://shalom.com.pe'},

    {'logo': 'static/images/dhl.png','nombre': 'DHL', 'sede_principal': 'Av. Inca Garcilaso de la Vega 1337, Cercado de Lima, Lima', 'descripcion': 'DHL es una empresa líder en logística a nivel mundial, especializada en envíos internacionales, servicios de mensajería y transporte', 'sitio_web': 'https://www.dhl.com/pe-es/home.html'},
    ...
    {'logo': 'static/images/fedex.png', 'nombre': 'FedEx', 'sede_principal': 'Pasaje Martir Olaya 260', 'descripcion': 'FedEx es una empresa de servicios de mensajería y logística que opera en Perú y a nivel mundial', 'sitio_web': 'https://www.fedex.com/es-pe/home.html'},

    {'logo': 'static/images/ups.png', 'nombre': 'Ups', 'sede_principal': 'Jr. Flora Tristan 310, Magdalena, Lima', 'descripcion': 'UPS ofrece opciones para envíos de bajo y gran volumen.', 'sitio_web': 'www.ups.com'},

    {'logo': 'static/images/urbano.png', 'nombre': 'Urbano', 'sede_principal': 'Avenida Materiales 3049, Cercado de Lima, Lima', 'descripcion': 'Urbano es una empresa de servicios logísticos en Perú. Su enfoque está en planificación urbana y desarrollo.', 'sitio_web': 'https://www.urbano.com.pe'},

    {'logo': 'static/images/transmar.png', 'nombre': 'Transmar', 'sede_principal': 'Avenida Nicolás Arriola 197, La Victoria', 'descripcion': 'Transmar es un grupo empresarial con 39 años de experiencia en el servicio de transporte de pasajeros, transporte de personal, encomiendas y transferencia de dinero.', 'sitio_web': 'https://transmar.pe'},
]
